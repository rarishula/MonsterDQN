...
MAX_DEPTH = 10
initial = FullGameSimulation(initial_player_monsters, initial_ai_monsters)
result = initial.run_game()

#initial_node.add_children_nodes()
#best_child = MCTS(initial_node)
print(result)
